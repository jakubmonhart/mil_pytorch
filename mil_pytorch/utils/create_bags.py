...
def create_bags(data, instance_labels, pos = 100, neg = 100, max_subbags = 7, max_instances = 7):
   data = np.array(data)
   ...
   return instances, np.array([subbag_ids, instance_ids]).astype(np.int64), labels.astype(np.int64)
